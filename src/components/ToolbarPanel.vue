...
const { styleState, editorBoxState, previewState, uiClassMap, uiStyleMap } = toRefs(props)
...
// transparent 不能直接显示在原生 color input 中，这里回显成白色占位。
...
<template>
  <div :class="['toolbar', uiClassMap.toolbar]" :style="uiStyleMap.toolbar">
